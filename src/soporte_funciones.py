...
def hisplot_grupos(df, columna_grupo, columna_metrica):
    """
    Genera histogramas con curvas de densidad para una métrica específica, organizados por subgrupos en un DataFrame.
    La visualización se ajusta en subplots, organizados en filas y columnas, según el número de grupos.
    ...
    columna_grupo : str
        Columna que identifica los grupos en el DataFrame.
    columna_metrica : str
        Columna que contiene la métrica a graficar en los histogramas.
